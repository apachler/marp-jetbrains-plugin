...
class OpenMarpPreviewAction : AnAction() {
    ...
    override fun actionPerformed(e: AnActionEvent) {
        ...
        // openFile will create both the source editor and our preview tab via
        // MarpPreviewFileEditorProvider.accept(). focusEditor=true ensures the
        // user sees the preview tab promoted if it wasn't already.
